...
FILES=(
  ...
  "docs/portable-usb-chain-restore-ai.md"
  "docs/portable-usb-chain-restore-human.md"
  ...
  "ops/codex_auto_resume.py"
  "ops/codex_boot_handoff.py"
  "ops/pool_ops.py"
  ...
  "ops/tests/test_ipfs_segment_backfill.py"
  "ops/tests/test_ipfs_segment_identity.py"
  "ops/tests/test_restore_rawdatadir_segment_artifact.py"
  ...
  "ops/systemd/user-bdag-codex-auto-resume.service"
  "ops/systemd/user-bdag-codex-boot-handoff.service"
